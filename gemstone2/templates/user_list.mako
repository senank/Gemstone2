...
<div class = "row" style = "padding: 10px; height : 25px;">
    <div class = "col-xs-3 text-center" style = "text-decoration: underline;">Name
    </div>
    <div class = "col-xs-3 text-center" style = "text-decoration: underline;">Username
    </div>
    <div class = "col-xs-3 text-center" style = "text-decoration: underline;">Permission
    </div>
    <div class = "col-xs-2 text-center" style = "text-decoration: underline;">Edit
    </div>
    <div class = "col-xs-1 text-center" style = "text-decoration: underline;">RESET
    </div>
</div>
%for x in users:
    ## %if x.user_id != request.user.user_id:
    <div class = "row" style = "padding: 10px; height : 25px;">
        <div class = "col-xs-3 text-center">${x.first_name.capitalize()} ${x.last_name.capitalize()}
        </div>
        <div class = "col-xs-3 text-center">${x.username}
        </div>
        <div class = "col-xs-3 text-center">${x.permissions}
        </div>
...
<div class = "row" style = "padding: 50px; height: 25px;">
    ...
    <div class = "col-xs-12">
        <a href = "${request.route_url('create')}"><button class = 'btn btn-labeled btn-success screenbtn' style = "margin: 1vw 0 0 84.9%;"><span class = "btn-label"><i class="fas fa-user-plus"></i></span>Create A New User</button></a>
    </div>
</div>